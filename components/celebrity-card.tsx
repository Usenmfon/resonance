  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 p-6">
        <div className="flex items-center justify-between gap-4 text-xs uppercase tracking-[0.26em] text-muted">
          <span>{celebrity.nationality}</span>
          <span>{celebrity.yearsActive}</span>
        </div>
        <div>
          <h3 className="font-display text-3xl uppercase tracking-display text-foreground">
            {celebrity.stageName}
          </h3>
        ...
        <div className="flex items-center justify-between gap-4 border-t border-line pt-4 text-xs uppercase tracking-[0.24em] text-foreground">
